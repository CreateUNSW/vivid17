...
void threadJob(int thid, int t, int *d) {
    ...
    for(int i = start; i < end; i++) {
        ...
        if(i == rand() % end) colourCrystal(img, i, red, green, blue, src);
    }
    //  colourCrystal(img, i, red, green, blue, src);
    // ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    // ===============================================================
}

void setup(int thid, int t, int *d) {
...
int main(int argc,char **argv) {
    ...
    for(int i = 0; i < NUM_THREADS; i++) {
            thread[i] = std::thread(setup, i, tP, d);
    }
