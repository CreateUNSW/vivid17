...
int main(int argc, char ** argv) {
	...
	int edges[MAX_CRYSTALS_NUM][MAX_EDGE_PER_CRYSTAL + 1] = {{-1}, {16, 6, 3, 2, -1}, {9, 7, 4, 1, -1}, {18, 12, 4, 1, -1}, {11, 9, 3, 2, -1}, {16, 6, -1}, {7, 5, 1, -1}, {8, 6, 2, -1}, {9, 7, -1}, {10, 8, 4, 2, -1}, {11, 9, -1}, {12, 10, 4, -1}, {13, 11, 3, -1}, {18, 12, -1}, {16, -1}, {18, 16, -1}, {15, 14, 5, 1, -1}, {18, -1}, {17, 15, 13, 3, -1}};
    Graph g(edges,19);
    int scanfFlag = 1;
    int i = 0;
    int src = 0;
